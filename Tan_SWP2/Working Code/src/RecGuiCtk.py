...
class RecGuiCtk(customtkinter.CTk):
    ...
    def __init__(self, dataBase=RecDbSqlite('AppDb.db')):
        ...
        self.font1 = ('Arial', 20, 'bold') #change
        self.font2 = ('Arial', 12, 'bold')  #change
        self.font3 = ('Arial', 50, 'bold', 'italic')
        ...
        self.add_button = self.newCtkButton(text='Add Recipe',
                                ...
                                fgColor='#05A312', #change
                                hoverColor='#00850B', #change
                                borderColor='#05A312') #change
        ...
        self.delete_button = self.newCtkButton(text='Delete Recipe',
                                    ...
                                    fgColor='#E40404', #change
                                    hoverColor='#AE0000', #change 
                                    borderColor='#E40404') #change
        ...
        self.style.configure('Treeview', 
                        font=self.font2, #change
                        foreground='#C7CBA8', #change
                        background='#FCF2AF', 
                        fieldlbackground='#313837') #change
    ...
    # new Button Widget change
    def newCtkButton(self, text = 'CTK Button', onClickHandler=None, fgColor='#FFF9EB', hoverColor='#FF5002' , bgColor='#FFF9EB', borderColor='#C88B90'): #change hover and border color (should be same color family)
        widget_Font=self.font1
    ...
    def export_to_csv(self):
        self.db.export_csv()
        messagebox.showinfo('Success', f'Data exported to {self.db.dbNameCSV}')
